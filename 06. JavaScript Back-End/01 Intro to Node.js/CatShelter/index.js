...
// const homePage = require("./views_old");
// const editCat = require("./views_old/editCat");
...
const server = http.createServer(async (req, res) => {
  ...
  if (req.url == "/") {
    ...
    let result = homePage.replace("{{cats}}", catsHtml);
...
function catTemplate(cat) {
  ...
  const modufyHtml = Object.keys(cat).reduce((result, key) => {
