...
import { detailsAlbumById, editAlbumById } from "../api/data.js";
import { createSubmitHandler } from "../util.js";

const edinTemplate = (album, onEdit) => html`
...
export async function showEdit(ctx) {
  ...
  ctx.render(edinTemplate(album, createSubmitHandler(onEdit)));
