...
const themeContentwarpper = document.getElementById("theme-content-wrapper");
...
async function appendElement() {
  ...
  themeContentwarpper.replaceChildren(res);
...
function topicTemplate(topic, comments) {
  ...
  commentContainer.innerHTML = ` 
              <div class="header">
                ...
                <p>
                  <span>${topic.username}</span> posted on <time>${topic.date}</time>
                </p>
